<template>
    ...
    <el-dialog v-model="dialogVisible" :title="editBrand ? 'Edit Brand' : 'Add Brand'" width="500"
        :before-close="handleClose">

        <form @submit.prevent="editBrand ? updateBrand() : AddBrand()" class="max-w-md mx-auto">
...
//add brand with value data
const AddBrand = async () => {
    const formData = new FormData();
    formData.append('name', name.value);

    try {
        await router.post('brand/store', formData, {
            onSuccess: (page) => {
...
const updateBrand = async () => {
    ...
    try {
        router.post('brand/update/' + id.value, formData, {
            onSuccess: (page) => {
                dialogVisible.value = false;
                resetForm();
                Swal.fire({
